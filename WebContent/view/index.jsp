									...
									<div class="row">
										<div class="col-sm-4">
											<form action="../ConnexionForm">
												...
												<input class="form-control" type="text" name="userName" placeholder="User Name" required="required"/></br>
											<input class="form-control" id="password" type="password" name="password" placeholder="Mot de passe" required="required"/></br>
										<a style="color:red"><c:out value="${connectionMsg}"/></a>
										<br>
											<div class="form-check">
												...
												<fieldset class="ref">
													<a href="#" style="color:black" onclick="openForm()">S'inscrire</a>
													<br>
														<a href="#" style="color:black">Mot de passe oublié
														</a>
														<br>
															<a href="faq.jsp" style="color:black">FAQ</a>
														...
														<form action="../InscriptionForm" class="form-container" name="inscription">
															<img src="../public/images/times.png" onclick="closeForm()" alt="close" class="close_button">
																...
																<br>
																	...
																	<br>
																		<a style="color:red"><c:out value="${sessionScope.inscrPseudoMsg}"/></a>
																		<br>
																			<input type="pseudo" placeholder="Pseudo" name="pseudo" required="required" class="field">
																				<input type="lastname" placeholder="Nom" name="lastname" required="required" class="field">
																					<input type="firstname" placeholder="Prenom" name="firstname" required="required" class="field">
																						<input type="email" placeholder="Adresse email" name="email" required="required" class="field">

																							<label for="year">Promotion :
																							</label>
																							<select type="number" id="year" name="year" required="required" class="field">
																								<option >
																									Choisir</option>
																							...
																							<input
																								...
																								required="required"
																								class="field">
																								<input id="passwordInsc2" type="password" placeholder="Vérification du mot de passe" name="secondPassword" required="required" class="field">
																									<br>
																										<a style="color:red"><c:out value="${sessionScope.inscrPswMsg}"/></a>
																										<br>
																											<div class="form-check2">
																												...
																												<br>
																													<div class="radio_but">
																														<input type="radio" id="client" name="categorie" value="Client" required="required">
																															Client
																															<input type="radio" id="commercant" name="categorie" value="Commercant" required="required">
																																Commerçant
																																<input type="radio" id="asso" name="categorie" value="Asso" required="required">
																																	Association
																																</div>
																																<br>
																																													...
																																													<div class="right_div">
																																														<img src="../public/images/hands.jpg" class="animated_img">
																																															<div class="behind_right">
																																																<h6>Notre équipe</h6>
																																																<img class="equipe" src="../public/images/equipe.png"></div>
																																															</div>
