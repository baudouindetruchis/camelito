				...
				<fieldset class="ref">
					...
					<div class="form-popup" id="myForm">
						<form action="../InscriptionForm" class="form-container" name="inscription">
							...
							<a style="color:red"><c:out value="${sessionScope.inscrPseudoMsg}"/></a><br>
							...
							<input id="passwordInsc1" type="password" placeholder="Mot de passe" name="password"
									pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Le mot de passe doit contenir au moins un chiffre, une majuscule et une minuscule, il doit aussi avoir au moins 8 caractères"
							...
							<div class="radio_but">
								<input type="radio" id="client" name="categorie" value="Client" required="required"> Client
								<input type="radio" id="commercant" name="categorie" value="Commercant" required="required">Commerçant
								<input type="radio" id="asso" name="categorie" value="Asso" required="required">Association
							</div><br>
